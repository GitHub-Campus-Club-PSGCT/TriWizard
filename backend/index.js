...
app.use(
  cors({
    origin: [
      process.env.FRONTEND_URL || "http://localhost:5173", // ✅ Participants frontend
      process.env.ADMIN_URL || "http://localhost:5174"     // ✅ Admin frontend
    ],
...
// ✅ Removed duplicate MongoDB connection - using connectDB() instead
// mongoose.connect() is already called in connectDB()
